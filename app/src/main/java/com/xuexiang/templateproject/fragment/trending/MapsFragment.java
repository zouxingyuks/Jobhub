...
import com.xuexiang.templateproject.databinding.FragmentMapsBinding;
...
public class MapsFragment extends BaseFragment<FragmentMapsBinding> {
    ...
    @NonNull
    @Override
    protected FragmentMapsBinding viewBindingInflate(LayoutInflater inflater, ViewGroup container) {
